...
class TestTaxes(TestCase):
    ...
    def test_reverse_apodoxes(self):
        self.assertEqual(tx1.reverse_apodoxes(2019, 1250, 16, 3), Decimal("1697.99"))
